...
filename2 = '/mnt/NewVolume/Documents/Researches/2024_Project/Astar/MAP/NGHICH/waypoint_1.txt'  # Second file with waypoints
filename3 = '/mnt/NewVolume/Documents/Researches/2024_Project/Astar/MAP/NGHICH/waypoint_2.txt'  # Third file with waypoints
filename4 = '/mnt/NewVolume/Documents/Researches/2024_Project/Astar/MAP/NGHICH/waypoint_3.txt'  # Third file with waypoints
filename5 = '/mnt/NewVolume/Documents/Researches/2024_Project/Astar/MAP/NGHICH/waypoint_4.txt'  # Third file with waypoints
filename6 = '/mnt/NewVolume/Documents/Researches/2024_Project/Astar/MAP/NGHICH/waypoint_5.txt'  # Third file with waypoints
...
waypoints6 = read_waypoints(filename6)
...
plot_path(waypoints1, 'gray', 'Path 1')  # Blue for path 1
...
plot_path(waypoints6, 'pink', 'Path 6')  # Green for path 5


# Add labels, title, and legend
plt.xlabel('Longitude')
plt.ylabel('Latitude')
plt.title('UTE - HD MAP')
plt.legend()
